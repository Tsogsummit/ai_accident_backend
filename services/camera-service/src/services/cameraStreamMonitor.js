...
class CameraStreamMonitor {
  constructor(pool, redis) {
    ...
    this.config = {
      videoDuration: 330, 
      checkInterval: '*/6 * * * *', 
      aiServiceUrl: process.env.AI_SERVICE_URL || 'http:
      videoServiceUrl: process.env.VIDEO_SERVICE_URL || 'http:
      accidentServiceUrl: process.env.ACCIDENT_SERVICE_URL || 'http:
    };
  }
